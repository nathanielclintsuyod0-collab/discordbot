...
const lyrics = [
  ...
  { time: 4.0, text: "On all your wasted cryin'" },
  { time: 8.0, text: "When you should be with me instead?" },
  { time: 12.0, text: "I know I can treat you better" },
  { time: 16.0, text: "Better than he can" }
];
